...
namespace GenericServices
{
    public class MembershipService : IMembershipService
    {
        ...
        //private readonly IEntityBaseRepository<User> _UserGeneric;
        ...
        public MembershipService(IEntityBaseRepository<DoctorUser> userRepository, IEntityBaseRepository<Role> roleRepository,
        ...
        public DoctorUser CreateUser(string username, string email, string password)
        {
            var existingUser = _userRepository.GetSingleByUsername(username);
            Guid[] rolesID = _roleRepository.GetAll().Select(x => x.ID).ToArray();
            ...
            addUserToRole(user, rolesID.FirstOrDefault());
        ...
        public List<DoctorUser> GetUsers()
        {
